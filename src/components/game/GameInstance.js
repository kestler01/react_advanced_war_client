...
class GameInstance extends Component {
  ...
  initialSet = (bigGameObj) => {
    ...
    this.setState({ gamePieces: newGamePieces })
  ...
  ComponentDidUpdate (prevProps) {
    ...
    console.log('in Component did update at GameInstance,prevProps:', prevProps)
    console.log('in Component did update at GameInstance,this.props:', this.props)
    console.log('in Component did update at GameInstance,this.state:', this.state)
  ...
  componentDidMount () {
    ...
    getGame(user, this.props.match.params.id)
      ...
      .then((res) => {
        ...
        console.log(' in game instance, on component did mount after initialSet Call, res.data, and state:', res.data, this.state)
        return res
      })
  ...
  render () {
    console.log(
      'in game instance render props & props.game:',
      this.props,
      this.props.game
    )
    console.log('in game instance the state is', this.state) // empty
    const demoPiece = { name: 'marine', position_x: 2, position_y: 1 }
